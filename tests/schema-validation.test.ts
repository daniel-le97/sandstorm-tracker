...
describe("Database Schema Validation", () => {
    ...
    test("Can insert server and query it back", () => {
        ...
        const serverId = "test-server-schema";
        const serverName = "Test Server Schema";
        const configId = "test-config-schema";
    ...
    test("Foreign key constraints work correctly", () => {
        ...
        `
            ...
            .get("fk-test-server", "FK Test Server", "fk-test-config", "/test/fk.log") as { id: number };
        ...
        expect(player.server_id).toBe("fk-test-server");
